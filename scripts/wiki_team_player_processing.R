...
for (i in teams_to_calc) {
   ...
   cat(glue("{teams$avg_name[i]},"), sep = " ")
   mode_name_parts <- get_mode_name(team_players)
   teams$mode_first_name[i] <- mode_name_parts$mode_first_name
   teams$mode_middle_name[i] <- mode_name_parts$mode_middle_name
   teams$mode_last_name[i] <- mode_name_parts$mode_last_name
   teams$mode_name[i] <- str_c(mode_name_parts$mode_first_name,
                              mode_name_parts$mode_middle_name,
                              mode_name_parts$mode_last_name,
                              sep = " ") %>% str_squish() %>% str_trim()
   cat(glue("{teams$mode_name[i]}"), sep = "\n")
}
